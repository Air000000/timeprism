...
- `src/composables/useHeatmapCalendar.ts`: heatmap month navigation, calendar computed adapters, cell classes, fetch-window calculation, and month progress summaries.
