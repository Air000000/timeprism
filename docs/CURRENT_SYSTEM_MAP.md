...
- `src-tauri/src/services/analytics_params.rs`: analytics limit/day/goal/root-filter normalization, heatmap level, usage-stack include-filter helpers, and related characterization tests.
