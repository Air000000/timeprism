...
- `src-tauri/src/services/analytics_params.rs`: analytics limit/day/goal/root-filter normalization, heatmap level helpers, and related characterization tests.
