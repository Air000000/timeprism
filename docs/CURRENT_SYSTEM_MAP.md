...
- `src/lib/petPanelDom.ts`: pet-panel initial shell template rendering, required DOM element lookup, week-header rendering, heatmap-grid DOM helpers, and usage-stack DOM helpers.
