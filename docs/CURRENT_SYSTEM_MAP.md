...
- `src/composables/useHeatmapCalendar.ts`: heatmap month navigation, calendar computed adapters, cell-class adapter, fetch-window calculation, and month progress summaries.
